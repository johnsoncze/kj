 ...
 */
class ShoppingCartIpAddressTest extends BaseTestCase
{
    ...
    public function testSetIpAddress()
    {
        ...
        $_SERVER['SERVER_ADDR'] = $ipAddress = '123.456.789';
        $ipAddressService = new ShoppingCartIpAddress();
        $ipAddressService->setIpAddress($cart);
...
(new ShoppingCartIpAddressTest())->run();