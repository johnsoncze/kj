...
final class Contact extends Control
{
    ...
    * @return Timeline
   */
   public function createComponentNavigationTimeline() : Timeline
   {
       $item1 = new Item();
       $item1->setReverse(FALSE);
       $item1->setTitle($this->translator->translate('pageStatic.contact.navigation.title'));
       ...
       $item1->setImages('<img src="/assets/front/images/layout/zlatnicka-dilna-ctime-zlatnicke-remeslo-2.jpg" alt="" class="Timeline-image-primary">
                           <img src="/assets/front/images/layout/zlatnicka-dilna-ctime-zlatnicke-remeslo-1.jpg" alt="" class="Timeline-image-secondary">
       ...
       $item2->setSubtitle($this->translator->translate('pageStatic.contact.navigation.publicTransport.title'));
       $item2->setDescription($this->translator->translate('pageStatic.contact.navigation.publicTransport.description'));
       ...
       $item3->setSubtitle($this->translator->translate('pageStatic.contact.navigation.car.subtitle'));
       $item3->setDescription($this->translator->translate('pageStatic.contact.navigation.car.description'));
       $item3->setItem2Class(' u-pt--30 u-sm-pt--0');
       $item3->setImagesClass(' u-mt--0 u-mb--0');
       $item3->setImages('<img src="/assets/front/images/layout/zlatnicka-dilna-techniky-2.jpg" alt="" class="Timeline-image-primary">');
