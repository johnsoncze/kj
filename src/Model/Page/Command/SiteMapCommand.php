...
final class SiteMapCommand extends BaseCommand
{
    ...
    {
        parent::configure();
        $this->setName('page:sitemap:generate')
            ->setDescription('Generate sitemaps with pages.');
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        foreach ($languages as $language) {
            ...
            $sitemapCount++;
            $this->logger->addInfo(sprintf('Page sitemap for language \'%s\' has been generated.', $language->getPrefix()));
        }

        $message = sprintf('Page sitemaps have been generated in %f seconds. Summary %d sitemaps.', Debugger::timer(), $sitemapCount);
